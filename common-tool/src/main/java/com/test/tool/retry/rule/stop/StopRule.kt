package com.test.tool.retry.rule.stop

import com.test.tool.retry.rule.stop.impl.NeverStopRule
import com.test.tool.retry.rule.stop.impl.StopAfterMaxAttemptRule
import com.test.tool.retry.rule.stop.impl.StopAfterMaxWaitTimeRule
